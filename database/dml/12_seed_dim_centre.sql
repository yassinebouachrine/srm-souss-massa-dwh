-- database/dml/12_seed_dim_centre.sql
-- Insertion des centres de distribution pour les 6 provinces de Souss-Massa

-- Vider la table existante (si besoin)
-- TRUNCATE gold.dim_centre CASCADE;

-- ═══════════════════════════════════════════════════
-- DP TATA (Province ID: 1)
-- ═══════════════════════════════════════════════════
INSERT INTO gold.dim_centre (id_centre, code_centre, nom_centre, type_centre, id_province) VALUES
...
-- ═══════════════════════════════════════════════════
-- DP CHTOUKA AIT BAHA (Province ID: 3)
-- ═══════════════════════════════════════════════════
INSERT INTO gold.dim_centre (id_centre, code_centre, nom_centre, type_centre, id_province) VALUES
...
-- ═══════════════════════════════════════════════════
-- DP INEZGANE AIT MELLOUL (Province ID: 5)
-- ═══════════════════════════════════════════════════
INSERT INTO gold.dim_centre (id_centre, code_centre, nom_centre, type_centre, id_province) VALUES
...
-- Vérification
-- ═══════════════════════════════════════════════════
-- SELECT p.nom_province, COUNT(c.id_centre) as nb_centres
-- FROM gold.dim_province p
-- LEFT JOIN gold.dim_centre c ON p.id_province = c.id_province
-- GROUP BY p.nom_province
-- ORDER BY p.nom_province;